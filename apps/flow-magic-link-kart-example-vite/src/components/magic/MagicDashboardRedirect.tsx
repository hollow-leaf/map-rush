    ...
    <div className="redirect-container">
      ...
      <div className="flex flex-col items-center flex-1">
        <div className="redirect-card">
          <div className="flex gap-2 mx-4 my-2 ">
            ...
            <h3 className="max-w-[480px] text-[#4E4D52] text-base font-normal">
              Please set your <code>VITE_MAGIC_API_KEY</code> environment variable in <code>.env</code>. You can
        ...
        <button className="api-button" onClick={onClick} disabled={false}>
          Get API keys
          <img src="/link_white.svg" alt="link-icon" className="ml-[6px] my-auto" />
        </button>
      </div>
      <DevLinks />
    </div>
